                    ...
                    <form method="post" action="{{ route('transaction.update', $transaction->id) }}" class="">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="customer" name="customer" type="text" class="mt-1 block w-full"
                                :value="old('customer', $transaction->customer)" required autofocus autocomplete="customer" />
                            ...
                            <x-select id="service" name="service_id" class="form-select">
                                ...
                                @foreach ($services as $service)
                                    <option value="{{ $service->id }}"
                                        {{ $service->id == $transaction->service_id ? 'selected' : '' }}>
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="berat" name="berat" type="text" class="block w-full mt-1"
                                :value="old('berat', $transaction->berat)" required autofocus autocomplete="berat" />
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="tgl_masuk" name="tgl_masuk" type="date" class="block w-full mt-1"
                                :value="old('tgl_masuk', $transaction->tgl_masuk)" required autofocus autocomplete="tgl_masuk" />
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="tgl_keluar" name="tgl_keluar" type="date" class="block w-full mt-1"
                                :value="old('tgl_keluar', $transaction->tgl_keluar)" required autofocus autocomplete="tgl_keluar" />
